...
import { servicePages } from "../../../data/contentHubData";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://majlistudio.com/services/${slug}`,
      languages: {
        "en-AE": `https://majlistudio.com/services/${slug}`,
        "ar-AE": `https://majlistudio.com/ar/services/${slug}`,
      },
    },
    openGraph: {
      title: service.title,
      description: service.description,
      url: `https://majlistudio.com/services/${slug}`,
