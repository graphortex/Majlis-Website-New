...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const article = compareArticles.find((a) => a.slug === slug);
  if (!article) return {};
  ...
  return {
    ...
    alternates: {
      canonical: `https://majlistudio.com/compare/${slug}`,
      languages: {
        "en-AE": `https://majlistudio.com/compare/${slug}`,
        "ar-AE": `https://majlistudio.com/ar/compare/${slug}`,
      },
    },
    openGraph: {
      title: article.title,
      description: article.description,
      url: `https://majlistudio.com/compare/${slug}`,
...
export default async function CompareArticlePage({ params }: PageProps) {
  ...
  const schemas = [
    breadcrumbSchema([
      ...
      { name: article.title, href: `/compare/${slug}` },
    ]),
    articleSchema({
